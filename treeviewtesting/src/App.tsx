...
registerLicense('Ngo9BigBOggjHTQxAR8/V1NGaF1cWGhBYVF/WmFZfV1gcF9HYlZRRGY/P1ZhSXxQdk1hW35YcXZVRmVVV0U=');
...
function App() {
  ...
  const addTreeNode = () => {
    ...
    if (treeview) {
      ...
      let data = treeview.getTreeData() //as TreeViewNode[];
      console.log(data);
      // const getNextId = (data) => {
        
      // }
      //data.push(new TreeViewNode())
    }
  }

  // maps the appropriate column to fields property
  let fields: object = { dataSource: sampleData, id: 'id', parentID: 'pid', text: 'name', hasChildren: 'hasChild', selected: 'isSelected' };
